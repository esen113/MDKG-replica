...
class Evaluator:
    ...
    def _print_results(self, per_type: List, micro: List, macro: List, types: List):
        ...
        results1 = ['                type    precision       recall     f1-score      support', '\n']
        for i in results:
            if "Health_factors" in i:
                results1.append(i)
                results1.append("\n")
        for i in results:
            if "disease" in i:
        ...
        for i in results:
            if "treatment_for" in i:
                results1.append(i)
                results1.append("\n")
        for i in results:
            if "location information" in i:
                results1.append(i)
                results1.append("\n")
        for i in results:
            if "Auxiliary relation" in i:
                results1.append(i)
                results1.append("\n")
        for i in results:
            if "help_diagnose" in i:
                results1.append(i)
                results1.append("\n")
        for i in results:
            if "risk_factor_of" in i:
                results1.append(i)
                results1.append("\n")
        for i in results:
            if "associated_with" in i:
                results1.append(i)
                results1.append("\n")
        for i in results:
            if "characteristic_of" in i:
                results1.append(i)
                results1.append("\n")
        for i in results:
            if "abbreviation_for" in i:
                results1.append(i)
                results1.append("\n")
        for i in results:
            if "hyponym_of" in i:
